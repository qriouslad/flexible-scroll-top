		...
		if ( $enabled == true ) {
			...
			wp_localize_script(
				...
				array(
					...
					'offsetShow'		=> $offset_show,
					'offsetFade'		=> $offset_fade,
	...
	public function activate_button() {
		...
		if ( $enabled == true ) {
			...
			switch ( $icon ) {
				...
				case 'up1':
					echo '<div class="fst"><a href="#" class="to-top fst-button"><svg viewBox="0 0 407.436 407.436" width="407.436" height="407.436"><polygon points="203.718,91.567 0,294.621 21.179,315.869 203.718,133.924 386.258,315.869 407.436,294.621 "/></svg></a></div>';
					break;
				case 'up2':
					echo '<div class="fst"><a href="#" class="to-top fst-button"><svg viewBox="0 0 32 32" width="32" height="32"><path clip-rule="evenodd" d="M15.251,0.279L0.307,15.223  c-0.202,0.202-0.301,0.467-0.299,0.731c0,0.008-0.004,0.014-0.004,0.022l0,15c0,0.552,0.448,1,1,1c0.008,0,0.014-0.004,0.022-0.004  c0.264,0.002,0.529-0.097,0.731-0.299l14.246-14.246l14.277,14.277c0.401,0.401,1.051,0.401,1.452,0  c0.238-0.238,0.317-0.561,0.273-0.87V16.122c0.044-0.309-0.035-0.632-0.273-0.87L16.76,0.28c-0.208-0.208-0.482-0.303-0.755-0.295  C15.733-0.023,15.459,0.072,15.251,0.279z M30.004,16.428v12.096L16.76,15.28c-0.208-0.208-0.482-0.303-0.755-0.295  c-0.272-0.008-0.546,0.087-0.754,0.295L2.004,28.526V16.425L16.003,2.427L30.004,16.428z" fill-rule="evenodd" id="Border_Arrow_Up"/><g/><g/><g/><g/><g/><g/></svg></a></div>';
					break;
				case 'up3':
					echo '<div class="fst"><a href="#" class="to-top fst-button"><svg viewBox="0 0 407.437 407.437" width="407.437" height="407.437"><g><polygon points="203.718,84.507 386.258,266.453 407.437,245.205 203.718,42.15 0,245.205 21.179,266.453"/><polygon points="0,344.039 21.179,365.287 203.718,183.341 386.258,365.287 407.437,344.039 203.718,140.984"/></g></svg></a></div>';
					break;
				case 'up4':
					echo '<div class="fst"><a href="#" class="to-top fst-button"><svg viewBox="0 0 386.257 386.257" width="386.257" height="386.257"><polygon points="193.129,96.879 0,289.379 386.257,289.379 "/></svg></a></div>';
					break;
				case 'up5':
					echo '<div class="fst"><a href="#" class="to-top fst-button"><svg viewBox="0 0 122.88 120.64" width="122.88" height="120.64"><g><path d="M108.91,66.6c1.63,1.55,3.74,2.31,5.85,2.28c2.11-0.03,4.2-0.84,5.79-2.44l0.12-0.12c1.5-1.58,2.23-3.6,2.2-5.61 c-0.03-2.01-0.82-4.01-2.37-5.55C102.85,37.5,84.9,20.03,67.11,2.48c-0.05-0.07-0.1-0.13-0.16-0.19C65.32,0.73,63.19-0.03,61.08,0 c-2.11,0.03-4.21,0.85-5.8,2.45l-0.26,0.27C37.47,20.21,19.87,37.65,2.36,55.17C0.82,56.71,0.03,58.7,0,60.71 c-0.03,2.01,0.7,4.03,2.21,5.61l0.15,0.15c1.58,1.57,3.66,2.38,5.76,2.41c2.1,0.03,4.22-0.73,5.85-2.28l47.27-47.22L108.91,66.6 L108.91,66.6z M106.91,118.37c1.62,1.54,3.73,2.29,5.83,2.26c2.11-0.03,4.2-0.84,5.79-2.44l0.12-0.12c1.5-1.57,2.23-3.6,2.21-5.61 c-0.03-2.01-0.82-4.02-2.37-5.55C101.2,89.63,84.2,71.76,67.12,54.24c-0.05-0.07-0.11-0.14-0.17-0.21 c-1.63-1.55-3.76-2.31-5.87-2.28c-2.11,0.03-4.21,0.85-5.8,2.45C38.33,71.7,21.44,89.27,4.51,106.8l-0.13,0.12 c-1.54,1.53-2.32,3.53-2.35,5.54c-0.03,2.01,0.7,4.03,2.21,5.61l0.15,0.15c1.58,1.57,3.66,2.38,5.76,2.41 c2.1,0.03,4.22-0.73,5.85-2.28l45.24-47.18L106.91,118.37L106.91,118.37z"/></g></svg></a></div>';
					break;
				case 'up7':
					echo '<div class="fst"><a href="#" class="to-top fst-button"><svg viewBox="0 0 32 32" width="32" height="32"><style type="text/css">.st0{;stroke-width:2;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:10;}</style><path d="M29.9,28.6l-13-26c-0.3-0.7-1.4-0.7-1.8,0l-13,26c-0.2,0.4-0.1,0.8,0.2,1.1C2.5,30,3,30.1,3.4,29.9L16,25.1l12.6,4.9c0.1,0,0.2,0.1,0.4,0.1c0.3,0,0.5-0.1,0.7-0.3C30,29.4,30.1,28.9,29.9,28.6z"/></svg></a></div>';
					break;
				case 'up8':
					echo '<div class="fst"><a href="#" class="to-top fst-button"><svg viewBox="0 0 32 32" width="32" height="32" class="fst-up8">
						<style type="text/css">
