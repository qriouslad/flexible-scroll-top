...
<div class="csf-welcome-cols">
  ...
  <div class="csf--col csf--col-first">
    <span class="csf--icon csf--<?php echo esc_attr( FLSCTO_CSF::$premium ? 'active' : 'deactive' ); ?>"><i class="fas fa-<?php echo esc_attr( FLSCTO_CSF::$premium ? 'check' : 'times' ); ?>"></i></span>
