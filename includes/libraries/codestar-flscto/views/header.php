...
<div class="csf-welcome csf-welcome-wrap">
  ...
  <h1>Welcome to Codestar Framework v<?php echo esc_attr( FLSCTO_CSF::$version ); ?></h1>
  ...
  <div class="csf-logo">
    ...
    <div class="csf--text csf--version">v<?php echo esc_attr( FLSCTO_CSF::$version ); ?></div>
  </div>
  ...
  <h2 class="nav-tab-wrapper wp-clearfix">
    <?php
      ...
      foreach ( $links as $key => $link ) {
        ...
        if ( FLSCTO_CSF::$premium && $key === 'free-vs-premium' ) { continue; }
