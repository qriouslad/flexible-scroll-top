 ...
 *
 */
if ( ! class_exists( 'FLSCTO_CSF_Field_accordion' ) ) {
  class FLSCTO_CSF_Field_accordion extends FLSCTO_CSF_Fields {
      ...
      foreach ( $this->field['accordions'] as $key => $accordion ) {
        ...
        echo '<div class="csf-accordion-item">';
          ...
          foreach ( $accordion['fields'] as $field ) {
            ...
            FLSCTO_CSF::field( $field, $field_value, $unique_id, 'field/accordion' );
