 ...
 *
 */
if ( ! class_exists( 'FLSCTO_CSF_Field_tabbed' ) ) {
  class FLSCTO_CSF_Field_tabbed extends FLSCTO_CSF_Fields {
    ...
    public function render() {
      ...
      foreach ( $this->field['tabs'] as $key => $tab ) {
        ...
        foreach ( $tab['fields'] as $field ) {
          ...
          FLSCTO_CSF::field( $field, $field_value, $unique_id, 'field/tabbed' );
