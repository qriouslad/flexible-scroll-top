 ...
 *
 */
if ( ! class_exists( 'FLSCTO_CSF_Field_icon' ) ) {
  class FLSCTO_CSF_Field_icon extends FLSCTO_CSF_Fields {
    ...
    public function enqueue() {
      add_action( 'admin_footer', array( 'FLSCTO_CSF_Field_icon', 'add_footer_modal_icon' ) );
      add_action( 'customize_controls_print_footer_scripts', array( 'FLSCTO_CSF_Field_icon', 'add_footer_modal_icon' ) );
    }
