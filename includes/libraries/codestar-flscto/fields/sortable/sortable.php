 ...
 *
 */
if ( ! class_exists( 'FLSCTO_CSF_Field_sortable' ) ) {
  class FLSCTO_CSF_Field_sortable extends FLSCTO_CSF_Fields {
    ...
    public function render() {
      ...
      foreach ( $pre_sortby as $key => $field ) {
        ...
        echo '<div class="csf-sortable-item">';
          ...
          FLSCTO_CSF::field( $field, $field_value, $unique_id, 'field/sortable' );
