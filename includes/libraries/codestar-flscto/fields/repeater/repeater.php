 ...
 *
 */
if ( ! class_exists( 'FLSCTO_CSF_Field_repeater' ) ) {
  class FLSCTO_CSF_Field_repeater extends FLSCTO_CSF_Fields {
    ...
    public function render() {
      ...
      if ( preg_match( '/'. preg_quote( '['. $this->field['id'] .']' ) .'/', $this->unique ) ) {
        ...
        foreach ( $this->field['fields'] as $field ) {
          ...
          FLSCTO_CSF::field( $field, $field_default, '___'. $field_unique, 'field/repeater' );
        ...
        if ( ! empty( $this->value ) && is_array( $this->value ) ) {
          ...
          foreach ( $this->value as $key => $value ) {
            ...
            foreach ( $this->field['fields'] as $field ) {
              ...
              FLSCTO_CSF::field( $field, $field_value, $field_unique, 'field/repeater' );
