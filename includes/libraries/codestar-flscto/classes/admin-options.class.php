 ...
 *
 */
if ( ! class_exists( 'FLSCTO_CSF_Options' ) ) {
  class FLSCTO_CSF_Options extends FLSCTO_CSF_Abstract {
    ...
    public function __construct( $key, $params = array() ) {
      ...
      $this->unique   = $key;
      $this->args     = apply_filters( "flscto_csf_{$this->unique}_args", wp_parse_args( $params['args'], $this->args ), $this );
      $this->sections = apply_filters( "flscto_csf_{$this->unique}_sections", $params['sections'], $this );
    ...
    public function set_options( $ajax = false ) {
      ...
      if ( wp_verify_nonce( $nonce, 'csf_options_nonce' ) ) {
        ...
        $data = apply_filters( "flscto_csf_{$this->unique}_save", $data, $this );

        do_action( "flscto_csf_{$this->unique}_save_before", $data, $this );

        $this->options = $data;

        $this->save_options( $data );

        do_action( "flscto_csf_{$this->unique}_save_after", $data, $this );
    ...
    public function save_options( $data ) {
      ...
      do_action( "flscto_csf_{$this->unique}_saved", $data, $this );
    ...
    public function add_options_html() {
      ...
      do_action( 'flscto_csf_options_before' );
            ...
            foreach ( $this->pre_sections as $section ) {
              ...
              if ( ! empty( $section['fields'] ) ) {
                ...
                foreach ( $section['fields'] as $field ) {
                  ...
                  FLSCTO_CSF::field( $field, $value, $this->unique, 'options' );
      ...
      do_action( 'flscto_csf_options_after' );
